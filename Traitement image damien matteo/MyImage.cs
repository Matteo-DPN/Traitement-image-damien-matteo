...
namespace Image_Morganico_Dupin
{
    public class MyImage
    {
        ...
        public MyImage()
        {
            ...
            this.matrice = new Pixel[400, 400];
        }
        public MyImage(string upimage, int tfichier, int toffset, int width, int height, int nb_bit_couleur, Pixel[,] matrice, string image)
        {
            this.Upimage = upimage;
            this.tfichier = tfichier;
            this.toffset = toffset;
            this.largeur = width;
            this.hauteur = height;
            this.nb_bit_couleur = nb_bit_couleur;
        ...
        public Pixel[,] Matrice { get { return matrice; } }
        public int Width { get { return largeur; } }
        public int Height { get { return hauteur; } }
        public void From_Image_To_File(string files)
        {
            ...
            for (int i = 0; i < matrice.GetLength(0); i++)
            {
                ...
                {
                    if (matrice[i, j] == null) new Pixel(255, 255, 255);
                    else
                    {
