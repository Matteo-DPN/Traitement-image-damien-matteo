    ...
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            static void Menu()
            {
                ...
                Console.WriteLine(s);
                Console.ResetColor();
                string nom_fichier = Choix_de_Fichier();
                MyImage image = new MyImage(nom_fichier);
                Choix_Mode(image);
            }
            static void Choix_Mode(MyImage image)
            {
                Console.Clear();
                    ...
                    case 4:
                        {
                            ...
                            image.Steganographie(Choix_de_Fichier());
            ...
            static void Retour_Menu(MyImage image)
            {
                Console.ForegroundColor = ConsoleColor.Green;
            ...
            static string Choix_de_Fichier()
            {
                Console.ForegroundColor = ConsoleColor.Blue;
                string Chaine_de_caractère = "";
                ConsoleKeyInfo key;
                ...
                {
                    Console.SetCursorPosition(left, top);
                    Console.WriteLine($"{(option == 1 ? color : "\u001b[35m")} Zelda\u001b[0m");
                    Console.WriteLine($"{(option == 2 ? color : "\u001b[35m")} Vangogh\u001b[0m");
                    Console.WriteLine($"{(option == 3 ? color : "\u001b[35m")} Poisson\u001b[0m");
                    Console.WriteLine($"{(option == 4 ? color : "\u001b[35m")} Plage\u001b[0m");
                    Console.WriteLine($"{(option == 5 ? color : "\u001b[35m")} Parapluies\u001b[0m");
                    Console.WriteLine($"{(option == 6 ? color : "\u001b[35m")} Montagne\u001b[0m");
                    Console.WriteLine($"{(option == 7 ? color : "\u001b[35m")} Mario\u001b[0m");
                    Console.WriteLine($"{(option == 8 ? color : "\u001b[35m")} Lena\u001b[0m");
                    Console.WriteLine($"{(option == 9 ? color : "\u001b[35m")} Lac en montagne\u001b[0m");
                    Console.WriteLine($"{(option == 10 ? color : "\u001b[35m")} Joconde\u001b[0m");
                    Console.WriteLine($"{(option == 11 ? color : "\u001b[35m")} Coco\u001b[0m");
                    Console.WriteLine($"{(option == 12 ? color : "\u001b[35m")} Chaton\u001b[0m");
                    Console.WriteLine($"{(option == 13 ? color : "\u001b[35m")} Cascade\u001b[0m");
                    Console.WriteLine($"{(option == 14 ? color : "\u001b[35m")} Automne\u001b[0m");
                    Console.WriteLine($"{(option == 15 ? color : "\u001b[35m")} Quitter\u001b[0m");
                    key = Console.ReadKey(true);
                    switch (key.Key)
                    {
                        case ConsoleKey.DownArrow:
